Rails.application.routes.draw do
  ...
  get "/profiles/:id/liked_comments", to: "profiles#liked_comments"
  ...
  post "/befriend/user", to: "relationships#create"
  delete "/unfriend/user/:user_id/:friend_id", to: "relationships#destroy"
